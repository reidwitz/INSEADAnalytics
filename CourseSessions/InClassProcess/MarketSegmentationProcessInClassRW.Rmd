...
datafile_name = "C:/Users/rwitzel/OneDrive/Documents/INSEAD/P3/Data Science/Tutorial 3/INSEADAnalytics/CourseSessions/Sessions23/data/Boats.csv"
...
minimum_variance_explained = 75  # between 1 and 100
...
*There are a few correlations that stick out:
*  3, 7 and 9 are lightly correlated: these customers view the boat as a sign of achievement, and brand may be important to them
*  13 - 17 are all lightly correlated: these customer are interested in boating technology and knowledge
*  20, 27 and 28 are correlated with each other: these customers view boating as their primary passion
*  The second and third cluster have some correlation to each other: passionate boaters are interested in technology
*  2, 8, 10 and 11 are all uncorrelated with the other answers: these boaters don't have broad interest in boating lifestyle and are 
    most swayed by cost or expert opinion
...
* The table shows us a breakdown of the new combined responses, as well as how well each new component captures the variation in the data
* An Eigenvalue of greater than 1 means that the component captures more variance than each original variable
* The chart takes the same data and represents it visually
* The plot has this shape because we ordered the components in descending order. The plotted line cannot be increasing.
* We prefer to see a large, sharp decrease followed by a flat tail. This would give us the ability to capture the most variation
...
* The first factor corresponds to a segment that considers themselves knowledgeable, and who prides themselves on buying the best of the best (Showy)
    They are motivated by others' perceptions and need to buy a well regarded boat
* The second factor explains a segment that uses boating as an escape, an adventure and who boat for the joy of it. They are more interested in the activity (Adventurers)
    than the boat itself
* The third factor is only interested in brand. (Status Symbols)
* The fourth seems like a DIY boater - they like to take care of their gear (DIY)
* The fifth is very price motivated (Budget)
*
* 
*
*
...
* Customer 1 is a showy, status symbol chasing adventurer
* Customer 2 is primarily showy and technology focused
* Customer 3 much like Customer 2
* Customer 4 is a status symbol enthusiast
* Customer 5 is interested in technology, branding and also DIY
* 
*
*
*
